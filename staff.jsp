            ...
            <div class="staffTable">
                ...
                <table class="tablecss">
                    ...
                    <%
                        ...
                        if(search != null){
                            selectQuery = "SELECT StaffFirstname, StaffLastname, StaffContact, StaffEmail, Type FROM staff "
                                    + "WHERE StaffFirstname like '%" + search + "%' AND StaffID IN (SELECT StaffID FROM subject WHERE subject.StudentID = " + stud_id + ")";
                        }
                        else{
                            selectQuery = "SELECT StaffFirstname, StaffLastname, StaffContact, StaffEmail, Type FROM staff "
                                    + "WHERE StaffID IN (SELECT StaffID FROM subject WHERE subject.StudentID = " + stud_id + ")";
                        }
