...
<html>
    ...
    <body>
        ...
        <form action="sendStaffMessage" method="post">
            ...
            $(document).ready(function () {
                ...
                $('#subject').change(function () {
                    ...
                    $.ajax({
                        ...
                        error: function (jqXHR, textStatus, errorThrown) {
                            $('#student').append('<option>Student Unavailable</option>');
                        },
                        cache: false
                    });
                });
        ...
        <div class="wrap-input100 validate-input m-b-50" style="float: none">
            ...
            <h3 style="margin: 4rem 0rem 2rem 3rem;">Messages</h3>
                ...
                <table class="tablecss">
                    ...
                    <%
                        ...
                        String selectQuery = "SELECT Subject, Content, Date, StudentFirstname, StudentLastname FROM message "
                                    + "INNER JOIN student ON message.SenderID = student.StudentID WHERE message.ReceiverID = " + staff_id;
